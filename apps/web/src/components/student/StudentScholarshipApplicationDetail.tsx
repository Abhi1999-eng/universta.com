...
export function StudentScholarshipApplicationDetail({ id }: { id: string }) {
  ...
  return <>
    <Link className="back-link" href="/student/scholarships">← My scholarships</Link>
