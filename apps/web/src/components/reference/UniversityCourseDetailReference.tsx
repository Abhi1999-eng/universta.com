      ...
      <section className="wrap" style={{ paddingTop: 8 }}>
        <div className="hero-banner">
          ...
          {offering.shortDescription ? (
            <p className="lede">{offering.shortDescription}</p>
          ) : null}
      ...
      <div className="wrap layout" style={{ paddingTop: 32 }}>
        <main className="main">
            ...
            <section className="block" id="highlights">
              ...
              {offering.subject ? (
                <p style={{ marginTop: 18 }}>
                  ...
                  <Link
                    className="link-more wrap"
                    href={`/subjects/${offering.subject.slug}`}
                  >
          ...
          {intakes.length ? (
            <section className="block" id="intakes">
              <div className="block-head">
                ...
                <p className="sub">
                  Application windows recorded against this programme.
                </p>
              </div>
              <div className="grid g3">
                {intakes.map((intake) => (
                  <article
                    className="card"
                    key={`${intake.label}-${intake.deadline ?? ""}`}
                  >
          ...
          {requirements.length ? (
            <section className="block" id="admission">
              <div className="block-head">
                ...
                <p className="sub">
                  Published requirements for this specific programme.
                </p>
              </div>
          ...
          {offering.tuition ? (
            <section className="block" id="cost">
              ...
              <p
                style={{ fontSize: 13.5, color: "var(--muted)", marginTop: 14 }}
              >
                Published figure
                {offering.verifiedAt
                  ? `, verified ${formatDate(offering.verifiedAt)}`
                  : ""}
          ...
          <section className="block">
            <div className="final-cta">
              ...
              <p>
                Check the intake deadline and entry requirements above, then
                talk it through with a counsellor before you submit.
              </p>
        ...
        <aside className="side">
          <div className="side-card">
            ...
            <p>
              A counsellor can check your profile against this programme’s
              requirements.
            </p>
