...
/** The Countries listing is the site's homepage. Section keys an admin can
 * use, via the generic Page CMS (Phase 1 content -> Pages -> a page with slug
 * "countries"), to override this listing's Hero and editorial section copy.
 * The live country/consultant/directory data these sections wrap always stays
 * data-driven -- only eyebrow/heading/subheading text can be overridden this
 * way. */
...
export default async function HomePage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  if (!data) return <main className="shell error-page"><p className="eyebrow">Countries</p><h1>Destinations are temporarily unavailable</h1><p>Please try again shortly.</p><Link className="button" href="/">Retry</Link></main>;
