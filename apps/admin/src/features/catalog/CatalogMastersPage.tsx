      ...
      {creating ? (
        <form onSubmit={(event) => void create(event)} className="mt-4 space-y-3 rounded-xl border border-[#E8ECF3] p-4">
          <label className="block text-sm font-semibold">
            <FieldLabel label="Name" required helpKey={`${kind === 'intake' ? 'intakes' : 'scholarship-providers'}.name`} />
          ...
          {kind === 'intake' ? (
            <label className="block text-sm font-semibold">
              <FieldLabel label="Month number (1-12, optional)" helpKey="intakes.monthNumber" />
            ...
            <label className="block text-sm font-semibold">
              <FieldLabel label="Website URL (optional)" help={commonFieldHelp.websiteUrl} />
