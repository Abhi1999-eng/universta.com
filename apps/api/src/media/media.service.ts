...
/** Every relation this app currently lets an editor attach media through.
 * Not exhaustive of every MediaAsset relation in the schema (Country/Subject/
 * Course editorial media has its own, separate admin surface not touched in
 * this pass) — this covers the resources reachable from the Phase 1
 * structured editors and the Page CMS, which is where the new Media Library
