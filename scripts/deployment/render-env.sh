...

{
  ...
  printf 'WEB_ORIGIN=%s\n' "${web_origin}"
  # Used by the public /preview response's frame-ancestors policy. Normal
  # public pages remain unframeable; only the protected Admin may embed a
  # short-lived draft preview.
